/**
 * 路由匹配单元测试（独立版本）
 * 测试文件：tests/unit/router-standalone.test.js
 * 
 * 不依赖编译后的代码，直接测试路由匹配逻辑
 */

const assert = require('assert');

// 路由匹配逻辑（从 router.ts 复制）
...
// 导出测试函数
module.exports = { runTests, testCases, matchRoute };
